...
import com.liuzhen.mylibrary.Utils.Dialog.base.BaseDialog;
...
public abstract class BaseAlertDialog<T extends BaseAlertDialog<T>> extends BaseDialog {
    ...
    public BaseAlertDialog(Context context) {
        ...
        btnLeftText = context.getResources().getString(R.string.cancle);
        btnRightText = context.getResources().getString(R.string.sure);
        ...
        tv_btn_right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onBtnRightClickL != null) {
                    onBtnRightClickL.onBtnClick(tv_content.getText().toString());
                } else {
                    dismiss();
                }
            }
        ...
        tv_btn_middle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onBtnMiddleClickL != null) {
                    onBtnMiddleClickL.onBtnClick(tv_content.getText().toString());
                } else {
                    dismiss();
                }
            }
